...
<div class="  text-capitalize text-center my-3">
	...
	<div id="_1" class="flex-wrap py-4">
		...
		@if($diagnosisDescriptionName == 'الم الصدر')
		<a href="{{ url('/chest1') }}" style="color:white;">
		...
		@if($diagnosisDescriptionName == 'خفقان القلب')
		<a href="{{ url('/chest2') }}" style="color:white;">
		<button id="begin" class="btn btn-success">
		لنبدأ
			</button>
			</a>
		...
		@if($diagnosisDescriptionName == ' الفم والعطش الشديد')
		<a href="{{ url('/chest3') }}" style="color:white;">
		<button id="begin" class="btn btn-success">
		لنبدأ
